...
function Slider:Display()
    ...
    -- Move the text higher above the slider (adjust this value to raise it further)
    DisplayLabel.Position = UDim2.new(0.5, 0, -1.5, 0)  -- Adjust '-1.5' to move it higher if needed
