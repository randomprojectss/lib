...
function Slider:Display()
    ...
    -- Move the text higher and more to the right above the slider
    DisplayLabel.Position = UDim2.new(0.4, 0, -2.2, 0)  -- Adjusted for higher position and more to the right
