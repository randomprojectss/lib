...
function Library:CreateWindow(...)
   ...
   -- Tab Area Creation (Unchanged)
local TabArea = Library:Create('Frame', {
    BackgroundTransparency = 1;
    Position = UDim2.new(0, 8, 0, 8);
    Size = UDim2.new(1, -16, 0, 30);  -- Increased height slightly for better fit
    ZIndex = 1;
...
local TabListLayout = Library:Create('UIListLayout', {
    Padding = UDim.new(0, Config.TabPadding);  -- Adjust padding here if needed
    FillDirection = Enum.FillDirection.Horizontal;
    SortOrder = Enum.SortOrder.LayoutOrder;
    Parent = TabArea;
});
...
local TabContainer = Library:Create('Frame', {
    BackgroundColor3 = Library.MainColor;
    BorderColor3 = Library.OutlineColor;
    Position = UDim2.new(0, 8, 0, 40);  -- Adjusted position to allow better layout
    Size = UDim2.new(1, -16, 1, -48);  -- Adjusted size for better fit without overflow
    ZIndex = 2;
    Parent = MainSectionInner;
});
...
function Window:AddTab(Name)
    ...
    -- Widening the Tab Button by adding more width
    ...
    local TabButton = Library:Create('Frame', {
        BackgroundColor3 = Library.BackgroundColor;
        BorderColor3 = Library.OutlineColor;
        Size = UDim2.new(0, TabButtonWidth + 12, 1, 0); -- Made it slightly wider by adding 12px
        ZIndex = 1;
        Parent = TabArea;
    });
    ...
    -- Ensure things fit better by adjusting container size and padding
