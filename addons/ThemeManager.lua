...
-- Notify the day when the script loads
local currentDate = os.date("%A, %B %d, %Y") -- e.g., "Monday, October 16, 2024"
ThemeManager.Library:Notify("Script loaded on: " .. currentDate)
